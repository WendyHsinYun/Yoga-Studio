...
.headerBar
    ...
    height: 100px
    opacity: 1
    // border: 0.1px solid blackborder: 0.1px solid black
    ...
    .router-home
        ...
        .logo
            width: 100%
            height: 100%
            background: url('../assets/images/lotus.svg') center/contain no-repeat
